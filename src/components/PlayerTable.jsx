...
const PlayerTable = ({ playerList, onAddNewPlayer, isLoading, isUser }) => {
    ...
    <div className="w-full h-full">
      ...
      >
        ...
        <select
          ...
          className={`px-4 py-3.5 border border-gray-300 rounded-md ${isMobile ? "mb-2" : (!isUser && "mr-4")
            } outline-primary`}
        >
      ...
      <table className="min-w-full bg-white border border-gray-300 shadow-lg">
        <thead>
          <tr>
            ...
            {!isUser && (<th className="py-2 px-4 border-b text-left">Action</th>)}
          </tr>
        </thead>
        <tbody>
          {isLoading ? (
